...
import {
    IProxyCreationCallback, SafeProxy
} from "@gnosis.pm/safe-contracts/contracts/proxies/IProxyCreationCallback.sol";
...
contract WalletRegistry is IProxyCreationCallback, Ownable {
    ...
    /**
     * @notice Function executed when user creates a Gnosis Safe wallet via SafeProxyFactory::createProxyWithCallback
