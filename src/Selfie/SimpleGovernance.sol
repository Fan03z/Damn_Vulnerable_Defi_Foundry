...
contract SimpleGovernance is ISimpleGovernance {
    uint256 private constant _ACTION_DELAY_IN_SECONDS = 2 days;
    ...
    function getActionDelay() external pure returns (uint256) {
        return _ACTION_DELAY_IN_SECONDS;
    }
    ...
    function _canBeExecuted(uint256 actionId) private view returns (bool) {
        ...
        return actionToExecute.executedAt == 0 && timeDelta >= _ACTION_DELAY_IN_SECONDS;
    }
